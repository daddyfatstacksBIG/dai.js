...
export const vatIlks = {
  generate : ilkName => ({
    ...
    contract : 'MCD_VAT',
    call : [
      'ilks(bytes32)(uint256,uint256,uint256,uint256,uint256)', toHex(ilkName)
    ]
  }),
  returns : [
    [ TOTAL_ENCUMBERED_DEBT, fromWei ], [ DEBT_SCALING_FACTOR, fromRay ],
    [ PRICE_WITH_SAFETY_MARGIN, fromRay ],
    [ DEBT_CEILING, v => MDAI(v, 'rad') ], [ DEBT_FLOOR, fromRad ]
  ]
};
