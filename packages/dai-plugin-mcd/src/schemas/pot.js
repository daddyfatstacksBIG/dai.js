...
export const potPie = {
  generate : () =>
      ({id : 'MCD_POT.Pie', contract : 'MCD_POT', call : [ 'Pie()(uint256)' ]}),
...
export const potDsr = {
  generate : () =>
      ({id : 'MCD_POT.dsr', contract : 'MCD_POT', call : [ 'dsr()(uint256)' ]}),
  returns : [ [ DAI_SAVINGS_RATE, fromRay ] ]
};
export const potChi = {
  generate : () =>
      ({id : 'MCD_POT.chi', contract : 'MCD_POT', call : [ 'chi()(uint256)' ]}),
  returns : [ [ SAVINGS_RATE_ACCUMULATOR, fromRay ] ]
};

export const potRho = {
  generate : () =>
      ({id : 'MCD_POT.rho', contract : 'MCD_POT', call : [ 'rho()(uint256)' ]}),
  returns :
...
export const annualDaiSavingsRate = {
  generate : () => ({
    ...
    computed : daiSavingsRate =>
        daiSavingsRate.pow(365 * 24 * 60 * 60).minus(1).times(100)
  })
};
