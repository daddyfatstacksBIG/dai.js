export default class VoteProxy {
  ...
  getProxyAddress() { return this._proxyAddress; }

  getColdAddress() { return this._coldAddress; }

  getHotAddress() { return this._hotAddress; }
}

const passthroughMethods = [
  'lock', 'free', 'voteExec', 'getNumDeposits', 'getVotedProposalAddresses'
];

Object.assign(VoteProxy.prototype, passthroughMethods.reduce((acc, name) => {
