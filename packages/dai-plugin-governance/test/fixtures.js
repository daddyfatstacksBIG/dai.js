...
export const dummyMkrSupportData = [
  {optionId : 1, mkrSupport : 40, percentage : 25, blockTimestamp : Date.now()},
  {optionId : 2, mkrSupport : 120, percentage : 75, blockTimestamp : Date.now()}
];
...
let i = 0;
export function dummyBlockNumber() { return [ 8017399, 8200000 ][i++ % 2]; }
