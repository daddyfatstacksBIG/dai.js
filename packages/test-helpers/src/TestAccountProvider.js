...
class TestAccountProvider {
  ...
  nextAddress() { return this._next().address; }

  nextAccount() { return this._next(); }
  ...
  setIndex(i) {
    if (typeof i !== 'number' || i < 0 ||
      ...
      throw new Error('Index must be a natural number between 0 and ' +
                      (this._accounts.addresses.length - 1) + ', got: ' + i);
    }
    this._setIndex(i);
  }
...
// eslint-disable-next-line
const i = process.env._TestProviderIndex ? // eslint-disable-next-line
