...
// this implementation assumes that all contracts in kovan.json, mainnet.json
// are also in testnet.json
const allContracts =
    Object.entries(testnetAddresses)
        .reduce((contracts, [ name, testnetAddress ]) => {
...
export default {
  addConfig:
      (_, {network = 'testnet', addressOverrides} = {}) => {
        const oldMkrData = {
          currency : OLD_MKR,
        ...
        return {
          ...
          token : {
            erc20 : [
              oldMkrData, {
                currency : MDAI_1,
                address : addContracts.MCD_DAI_1.address[network]
              }
            ]
          },
