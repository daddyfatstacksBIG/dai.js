...
describe('Global Settlement Collateral Claims migration', () => {
  beforeAll(async () => {
    ...
    migration =
        maker.service(ServiceRoles.MIGRATION)
  ...
  test(
      'if the system is NOT in global settlement and there is no collateral, return false',
      async () => {
  ...
  test(
      'if the system is NOT in global settlement and there is collateral, return false',
      async () => {
        mockContracts(smartContract,
                      {MCD_END_1 : globalSettlement.beforeCage()});
  ...
  test(
      'if the system IS in global settlement, but collateral is not caged, and there is no collateral, return false',
      async () => {
        mockContracts(smartContract,
  ...
  test(
      'if the system IS in global settlement, but collateral is not caged, and there is collateral, return false',
      async () => {
        await setupCollateral(maker, 'ETH-A', {price : 150, debtCeiling : 50});
        await cdpManager.openLockAndDraw('ETH-A', ETH(0.1), MDAI(1));
  ...
  test(
      'if the system IS in global settlement and collateral is caged, and there is no collateral, return false',
      async () => {
        mockContracts(smartContract, {
  ...
  test(
      'if the system IS in global settlement and collateral is caged, and there is NO collateral to skim, return false',
      async () => {
        await setupCollateral(maker, 'ETH-A', {price : 150, debtCeiling : 50});
  ...
  test(
      'if the system IS in global settlement and collateral is caged, and there IS collateral to skim, return true',
      async () => {
        await setupCollateral(maker, 'ETH-A', {price : 150, debtCeiling : 50});
        await cdpManager.openLockAndDraw('ETH-A', ETH(0.1), MDAI(1));
