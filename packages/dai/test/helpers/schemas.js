...
import { bytesToString, fromWei, numberToBytes32 } from '../../src/utils/conversion';
...
export const tubRum = {
  generate: () => ({ id: 'SAI_TUB.rum', contract: 'SAI_TUB', call: ['rum()(uint256)'] }),
...
export const tubCap = {
  generate: () => ({ id: 'SAI_TUB.cap', contract: 'SAI_TUB', call: ['cap()(uint256)'] }),
