  ...
  _create({lockAndDraw = false, amountEth = null, amountDai = null} = {}) {
    ...
    if (!this.dsProxyAddress) {
      const proxyRegistryAddress =
          this._smartContractService.getContractAddressByName(
              contracts.PROXY_REGISTRY); // prettier-ignore
...
// If the second array item is true then the method name with 'Proxy' appended
