...
export function contractAddressesInfo(addresses) {
  return {
    ...
    // Multicall
    [contracts.MULTICALL] :
        [ {version : 1, address : addresses.MULTICALL, abi : abis.multicall} ],

    // Proxies
    [contracts.SAI_PROXY] : [
      {version : 1, address : addresses.SAI_PROXY, abi : abis.proxies.saiProxy}
    ],
    ...
    [contracts.DS_PROXY] : [ {version : 1, abi : abis.dappHub.dsProxy} ],
...
export default [
  ...
  {name : 'morden', networkId : 2}, {name : 'ropsten', networkId : 3},
  {name : 'rinkeby', networkId : 4}, {name : 'goerli', networkId : 5},
